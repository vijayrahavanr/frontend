...
/**
 * Snapshot of a class session's attendance: percentage ring plus
 * present/absent/late counts. Used on the faculty Dashboard and at
 * the top of Mark Attendance / Attendance Details.
 *
 * @param {object} props
 ...
 */
const AttendanceOverviewCard = ({ percentage, present, absent, late = 0, total, className }) => {
    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-2">
        <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">
          Class Attendance {total ? `(${total} students)` : ''}
        </p>
