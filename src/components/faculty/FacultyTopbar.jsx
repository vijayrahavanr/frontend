...
/**
 * Faculty-scoped page top bar: title on the left, search + actions on
 * the right. Mirrors student/StudentTopbar's contract so both roles'
 * pages share the same header pattern.
 *
 * @param {object} props
