...
/**
 * Dashboard KPI tile for student-facing stats (attendance %, classes
 * today, pending leaves, etc). Thin, color-themed layer over the
 * shared StatCard rather than reimplementing its card/skeleton logic.
 *
 * @param {object} props
 * @param {keyof typeof COLOR_CLASSES} [props.color]
 */
const StudentStatCard = ({ color = 'primary', ...rest }) => (
